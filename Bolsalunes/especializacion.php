...
//////////////////////////////////////////////////
    ...
    <body style='background-image:url(fondo/wallpaper.jpg);background-attachment:fixed;background-repeat:no-repeat;background-position:50% 50%;'>
        ...
        <form action="valida_especializacion.php" method="POST" enctype="multipart/form-data">
            <div class="row">

                <div class="col-md-12">
                    <div class="form-group">
                        <select class="form-control" name="p_id_tipo_especializacion" id='p_id_tipo_especializacion'>
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Carrera Profecional y7o Minicurso" name="p_nombre_especializacion" value="" />

                    </div>

                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Universidad  / instituto" name="p_universidad" value="" />
