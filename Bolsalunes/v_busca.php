...
<html class="no-js" lang="en"> <!--<![endif]-->
    ...
    {        
            function adicionar(id_pagina) {
                ...
                $.post("busca.php", { f: 'PopupParametro' }, function (data) {
                    carga_modal(vg_dlg, data, false, true, 800, '::: Buscar por preferencias :::', ['center', 120], [
...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        ...
        <?php if ($flag_nuevo == 1) { ?>
            <button href='javascript:void(0);' onclick='adicionar(<?php echo $id_pagina; ?>);' class="btn btn-primary" rel="tooltip" data-placement="top" data-original-title="agregar"><i class="fa fa-plus-circle"></i> Nuevo Empleado</button>
        <?php } ?>
     </div>
