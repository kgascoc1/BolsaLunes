...
$lista = $obj_estudio->sp_dame_estudio(0);
?>
...
if (screen.width >= 660) {  
    function adicionar(id_pagina) {
        var p_accion = "I";
        $.post("p_estudio.php", {f: 'PopupParametro'}, function (data) {
            carga_modal(vg_dlg, data, false, true, 660, '::: Registrar estudios realizados :::', ['center', 120], [
    ...
    function modificar(p_id, id_pagina) {
                var p_accion = "A";
                $.post("p_estudio.php", {p_id: p_id}, function (data) {
                    carga_modal(vg_dlg, data, false, true, 660, '::: Modificar estudios realizados:::', ['center', 120], [{
                            text: "Aceptar", click: function () {
                                adicionar_nuevo(p_accion, id_pagina);
                            }
                        }, {text: "Cerrar", click: function () {
        ...
        var p_accion = "I";
        $.post("p_estudio.php", {f: 'PopupParametro'}, function (data) {
            carga_modal(vg_dlg, data, false, true, 320, '::: Registrar estudios realizados :::', ['center', 120], [
                {text: "Aceptar", click: function () {
                        adicionar_nuevo(p_accion, id_pagina);
                    }},
                {text: "Cerrar", click: function () {
    ...
    function modificar(p_id, id_pagina) {
                var p_accion = "A";
                $.post("p_estudio.php", {p_id: p_id}, function (data) {
                    carga_modal(vg_dlg, data, false, true, 320, '::: Modificar estudios realizados:::', ['center', 120], [{
                            text: "Aceptar", click: function () {
                                adicionar_nuevo(p_accion, id_pagina);
                            }
                        }, {text: "Cerrar", click: function () {
...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        ...
        <?php if ($flag_nuevo == 1) { ?>
            <button href='javascript:void(0);' onclick='adicionar(<?php echo $id_pagina; ?>);' class="btn btn-primary" rel="tooltip" data-placement="top" data-original-title="agregar"><i class="fa fa-plus-circle"></i> Nuevo </button>
        <?php } ?>
        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-3" data-widget-editbutton="false">
                ...
                <header>
                    ...
                    <h2>Estudios Primarios y Secundarios</h2>
                        ...
                        <table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            <tbody>
                                ...
                                for ($i = 0; $i < count($lista); $i++) {
                                     $cod_estudio = $lista[$i]["id_estudio"];
                                    
                                    $tiponombre = $lista[$i]["tiponombre"];
                                    $institucion = $lista[$i]["institucion"];
                                    ...
                                    <tr>
                                        ...
                                        <td align='left' width='15%'><?php echo $tiponombre; ?></td>
                                        <td align='left' width='15%'><?php echo $institucion; ?></td>
                                        
                                        <td align='center' width='15%'><?php echo $fecha_inicio; ?></td>
                                        <td align='center' width='15%'><?php echo $fecha_fin; ?></td>
                                         
                                        <td align='center' width='15%'><?php echo '<img src="'.$descripcion.'" width="100" heigth="100"><br>'; ?></td>
                                        <td align='center' width='15%'>
                                            <?php if ($flag_modif == 1) { ?>
                                                <a class="btn btn-xs btn-primary" rel="tooltip" data-placement="top" data-original-title="editar" href='javascript:void(0);' onclick='modificar(<?php echo $cod_estudio; ?>,<?php echo $id_pagina; ?>);' ><i class="fa fa-pencil"></i></a> 
                                                <?php
                                            }
                             
                                            if ($flag_elim == 1) {
                                                ?> 
                                                <a class="btn btn-xs btn-danger" rel="tooltip" data-placement="top" id="perrito" data-original-title="eliminar" href='javascript:void(0);' onclick='preguntar_eliminar(<?php echo $cod_estudio; ?>,<?php echo $id_pagina; ?>);' ><i class="fa fa-times"></i></a> 
