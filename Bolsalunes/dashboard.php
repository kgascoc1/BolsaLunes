...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        <h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-home"></i> Principal <span>> Bolsa de Trabajo - Abogados</span></h1>
    </div>
...
<section id="widget-grid" class="">
    ...
    <div class="row">
        <article class="col-sm-12">
            ...
            <div class="alert alert-info fade in alert-block">
                <h4 class="alert-heading">Bienvenido a Bolsa de Trabajo v0.01</h4><br>
                <a href=" indexvc.html">Envia mensajes o notificaciones</a>
