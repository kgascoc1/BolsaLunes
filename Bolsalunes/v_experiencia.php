...
$lista = $obj_experiencia->sp_dame_experiencia(0);
?>
...
if (screen.width >= 660) {    
    function adicionar(id_pagina) {
        ...
        $.post("experiencia.php", {f: 'PopupParametro'}, function (data) {
            carga_modal(vg_dlg, data, false, true, 660, '::: Registrar Experiencias Laborales :::', ['center', 120] )
        });
    }
        ...
        $.post("experiencia.php", {f: 'PopupParametro'}, function (data) {
            carga_modal(vg_dlg, data, false, true, 320, '::: Registrar Experiencias Laborales :::', ['center', 120] )
        });
    }
    ...
    function eliminar(codigo, id_pagina)
    {
        $.post('adm/controller/c_experiencia.php', {
            p_id_experiencia: codigo,
            p_empresa: "x",
            p_puesto: "x",
            p_trabajo_realizado: "x",
            p_fecha_inicio: "x",
            p_fecha_fin: "x",
            p_descripcion: "x",
            p_accion: "E",
...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        ...
        <?php if ($flag_nuevo == 1) { ?> <!-- Aqui prmite Registra Experiencia-->
            <button href='javascript:void(0);' onclick='adicionar(<?php echo $id_pagina; ?>);' class="btn btn-primary" rel="tooltip" data-placement="top" data-original-title="agregar"><i class="fa fa-plus-circle"></i> Nueva Experiencia</button>
        <?php } ?>
                        ...
                        <table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            <tbody>
                                ...
                                for ($i = 0; $i < count($lista); $i++) {
                                    $cod_experiencia = $lista[$i]["id_experiencia"];

                                    $empresa = $lista[$i]["empresa"];

                                    $puesto = $lista[$i]["puesto"];
                                    $trabajo_realizado = $lista[$i]["trabajo_realizado"];
                                    ...
                                    <tr>
                                        ...
                                        <td align='left' width='15%'><?php echo $empresa; ?></td>
                                        <td align='left' width='15%'><?php echo $puesto; ?></td>
                                        <td align='left' width='15%'><?php echo $trabajo_realizado; ?></td>
                                        ...
                                        <td align='center' width='10%'>
                                            ...
                                            if ($flag_elim == 1) {
                                                ?> 
                                                <a class="btn btn-xs btn-danger" rel="tooltip" data-placement="top" id="perrito" data-original-title="eliminar" href='javascript:void(0);' onclick='preguntar_eliminar(<?php echo $cod_experiencia; ?>,<?php echo $id_pagina; ?>);' ><i class="fa fa-times"></i></a> 
