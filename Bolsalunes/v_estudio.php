...
if (screen.width >= 660) { 
    function adicionar(id_pagina) {
        ...
        $.post("indexx.php", {f: 'PopupParametro'}, function (data) {
...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        ...
        <?php if ($flag_nuevo == 1) { ?>  <!-- Permite Registrar Estudios -->
            <button href='javascript:void(0);' onclick='adicionar(<?php echo $id_pagina; ?>);' class="btn btn-primary" rel="tooltip" data-placement="top" data-original-title="agregar"><i class="fa fa-plus-circle"></i> Agregar Estudios Realizados</button>
        <?php } ?>
