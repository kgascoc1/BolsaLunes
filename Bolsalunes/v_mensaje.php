...
$lista = $obj->dame_persona22($id_persona);
?>
<!doctype html>
                                ...
                                <table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr> 
                                            ...
                                            <td class='left' width='30%'><?php echo $empresa; ?></td>
                                            <td class='center' width='10%'><?php echo $correo; ?></td> 

                                            <td class='left' width='15%'><?php echo $telefono; ?></td>
                                            <td class='left' width='15%'><?php echo $direccion; ?></td>
                                            <td class='left' width='20%'><?php echo $descripcion; ?></td>
