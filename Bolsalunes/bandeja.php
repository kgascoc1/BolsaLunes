...
<html>
  ...
  <body>
    <div class="container">
      <h1>Gmail Colegiados </h1>

	    

	      <button id="authorize-button" class="btn btn-primary hidden">Activar</button>
    ...
    <div class="modal fade col-md-11" id="reply-modal" tabindex="-1" role="dialog">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    ...
    <script type="text/javascript">
      var clientId = '470490100338-rj3rn4hva8pjn7d81amk4biug0gehkuv.apps.googleusercontent.com';
      var apiKey = 'AIzaSyCOEwlZAQe_5_FZCHn9_2W8c1AN3nLIGi4';
      var scopes =
      ...
      function appendMessageRow(message) {
        ...
        $('body').append(
          '<div class="modal fade col-md-11" id="message-modal-' + message.id +
