...
<script>
    ...
    function adicionar(id_pagina) {
        var p_accion = "I";
        $.post("p_rol.php", {f: 'PopupParametro'}, function (data) {
            carga_modal(vg_dlg, data, false, true, 660, '::: Registrar Rol :::', ['center', 120], [
    ...
    function modificar(p_id, id_pagina) {
        ...
        $.post("p_rol.php", {f: 'PopupParametro'}, function (data) {
            cargar_data(p_id);
            carga_modal(vg_dlg, data, false, true, 660, '::: Modificar Rol:::', ['center', 120], [{
                    text: "Aceptar", click: function () {
                        adicionar_nuevo(p_accion, id_pagina);
                    }
                }, {text: "Cerrar", click: function () {
        ...
        var p_accion = "I";
        $.post("p_rol.php", {f: 'PopupParametro'}, function (data) {
            carga_modal(vg_dlg, data, false, true, 320, '::: Registrar Rol :::', ['center', 120], [
                {text: "Aceptar", click: function () {
                        adicionar_nuevo(p_accion, id_pagina);
                    }},
                {text: "Cerrar", click: function () {
    ...
    function modificar(p_id, id_pagina) {
        ...
        $.post("p_rol.php", {f: 'PopupParametro'}, function (data) {
            cargar_data(p_id);
            carga_modal(vg_dlg, data, false, true, 320, '::: Modificar Rol:::', ['center', 120], [{
                    text: "Aceptar", click: function () {
                        adicionar_nuevo(p_accion, id_pagina);
                    }
                }, {text: "Cerrar", click: function () {
...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        ...
        <?php if ($flag_nuevo == 1) { ?>
            <button href='javascript:void(0);' onclick='adicionar(<?php echo $id_pagina; ?>);' class="btn btn-primary" rel="tooltip" data-placement="top" data-original-title="agregar"><i class="fa fa-plus-circle"></i> Nuevo Rol</button>
        <?php } ?>
                        ...
                        <table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            <tbody>
                                ...
                                for ($i = 0; $i < count($lista_roles); $i++) {
                                    $cod_rol = $lista_roles[$i]["id_rol"];
                                    $nombre = $lista_roles[$i]["nombre"];
                                    $abreviatura = $lista_roles[$i]["abreviatura"];
                                    $ind_estado = $lista_roles[$i]["ind_estado"];
                                    ...
                                    <tr>
                                        <td align='center' width='10%'><?php echo $cod_rol; ?> </td>
                                        <td align='left' width='45%'><?php echo $nombre; ?></td>
                                        <td align='left' width='30%'><?php echo $abreviatura; ?></td>
                                        <td align='center' width='10%'><?php echo $msg_estado; ?></td>
                                        <td align='center' width='5%'>
                                            <?php if ($flag_modif == 1) { ?>
                                                <a class="btn btn-xs btn-primary" rel="tooltip" data-placement="top" data-original-title="editar" href='javascript:void(0);' onclick='modificar(<?php echo $cod_rol; ?>,<?php echo $id_pagina; ?>);' ><i class="fa fa-pencil"></i></a> 
                                                <?php
                                            }
                                            if ($flag_elim == 1) {
                                                ?> 
                                                <a class="btn btn-xs btn-danger" rel="tooltip" data-placement="top" id="perrito" data-original-title="eliminar" href='javascript:void(0);' onclick='preguntar_eliminar(<?php echo $cod_rol; ?>,<?php echo $id_pagina; ?>);' ><i class="fa fa-times"></i></a> 
