            ...
            <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false"	data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-sortable="false">
                ...
                <div>
                    ...
                    <div class="widget-body">
                            ...
                            <fieldset>
                                <legend>
                                    Asignación de Páginas por Modulos
                                </legend>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 selectContainer">
                                            ...
                                            <select id="dd_modulo" class="form-control" name="dd_modulo" onchange="ver_paginas_x_modulo(<?php echo $id_pagina; ?>);" >
                                                <option value='0'> -- SELECCIONE -- </option>
                                                <?php
                                                for ($i = 0; $i < count($lista_modulo); $i++) {
                                                    $codigo = $lista_modulo[$i]["codigo"];
                                                    $coddes = $lista_modulo[$i]["coddes"];
                                                    $descripcion = $lista_modulo[$i]["descripcion"];
                                                    ?>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-2">
                                            <input type="checkbox" name="cb_estado" id="cb_estado" checked>
                                            <label for="cb_estado">Activo</label>
                                        </div>
                                        <div class="col-sm-12 col-md-2">
                                            <?php if ($flag_nuevo == 1) { ?>
                                                <button href="javascript:void(0);" onclick="agregar_pagina_x_modulo(<?php echo $id_pagina; ?>);" class="btn btn-default"><span class="icon icon-plus"></span>Agregar</button>
                                            <?php } ?>
                                        </div>
                                    </div>
