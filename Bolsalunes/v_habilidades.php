...
$lista = $obj_habilidades->sp_dame_habilidades(0);
?>
...
if (screen.width >= 660) {
    function adicionar(id_pagina) {
        var p_accion = "I";
        $.post("p_habilidades.php", {f: 'PopupParametro'}, function (data) {
            carga_modal(vg_dlg, data, false, true, 660, '::: Registrar habilidades :::', ['center', 120], [
    ...
    function adicionar(id_pagina) {
        var p_accion = "I";
        $.post("p_habilidades.php", {f: 'PopupParametro'}, function (data) {
            carga_modal(vg_dlg, data, false, true, 320, '::: Registrar habilidades :::', ['center', 120], [
                {text: "Aceptar", click: function () {
                        adicionar_nuevo(p_accion, id_pagina);
                    }},
                {text: "Cerrar", click: function () {
    ...
    function eliminar(codigo, id_pagina)
    {
        $.post('adm/controller/c_habilidades.php', {
            p_id_habilidades: codigo,
            p_id_tipo_habilidades:1,
            p_accion: "E",
        }, function (data) {
            console.log(data);
            if (data == 'OK') {
...
<div class="row">
    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
        ...
        <?php if ($flag_nuevo == 1) { ?>
            <button href='javascript:void(0);' onclick='adicionar(<?php echo $id_pagina; ?>);' class="btn btn-primary" rel="tooltip" data-placement="top" data-original-title="agregar"><i class="fa fa-plus-circle"></i> Nuevo habiliad</button>
        <?php } ?>
                        ...
                        <table id="datatable_tabletools" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            <tbody>
                                ...
                                for ($i = 0; $i < count($lista); $i++) {
                                    $cod_habilidades = $lista[$i]["id_habilidades"];
                                    ...
                                    <tr>
                                        ...
                                        <td align='left' width='85%'><?php echo $nombre; ?></td> 
                                        <td align='center' width='15%'>
                                            <?php
                                            if ($flag_elim == 1) {
                                                ?> 
                                                <a class="btn btn-xs btn-danger" rel="tooltip" data-placement="top" id="perrito" data-original-title="eliminar" href='javascript:void(0);' onclick='preguntar_eliminar(<?php echo $cod_habilidades; ?>,<?php echo $id_pagina; ?>);' ><i class="fa fa-times"></i></a> 
